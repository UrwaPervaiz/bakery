						...
						<div class="cake_feature_item">
							...
							<div class="cake_text">
								...
								<form action="add_to_cart.php" method="post">
									<input type="hidden" name="image" value="img/cake-feature/c-feature-1.jpg">
									<input type="hidden" name="price" value="$29">
									<input type="hidden" name="name" value="Strawberry Cupcakes">
									<button type="submit" class="pest_btn">Add to cart</button>
								</form>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-4 col-6">
						<div class="cake_feature_item">
							...
							<div class="cake_text">
								...
								<h3>Strawberry Cupcakes</h3>
								<form action="add_to_cart.php" method="post">
									<input type="hidden" name="image" value="img/cake-feature/c-feature-2.jpg">
									<input type="hidden" name="price" value="$29">
									<input type="hidden" name="name" value="Strawberry Cupcakes">
									<button type="submit" class="pest_btn">Add to cart</button>
								</form>
					...
					<div class="col-lg-3 col-md-4 col-6">
						<div class="cake_feature_item">
							...
							<div class="cake_text">
								...
								<h3>Strawberry Cupcakes</h3>
								<form action="add_to_cart.php" method="post">
									<input type="hidden" name="image" value="img/cake-feature/c-feature-3.jpg">
									<input type="hidden" name="price" value="$29">
									<input type="hidden" name="name" value="Strawberry Cupcakes">
									<button type="submit" class="pest_btn">Add to cart</button>
								</form>
					...
					<div class="col-lg-3 col-md-4 col-6">
						<div class="cake_feature_item">
							...
							<div class="cake_text">
								...
								<h3>Strawberry Cupcakes</h3>
								<form action="add_to_cart.php" method="post">
									<input type="hidden" name="image" value="img/cake-feature/c-feature-9.jpg">
									<input type="hidden" name="price" value="$29">
									<input type="hidden" name="name" value="Strawberry Cupcakes">
									<button type="submit" class="pest_btn">Add to cart</button>
								</form>
					...
					<div class="col-lg-3 col-md-4 col-6">
						<div class="cake_feature_item">
							...
							<div class="cake_text">
								...
								<h3>Strawberry Cupcakes</h3>
								<form action="add_to_cart.php" method="post">
									<input type="hidden" name="image" value="img/cake-feature/c-feature-4.jpg">
									<input type="hidden" name="price" value="$29">
									<input type="hidden" name="name" value="Strawberry Cupcakes">
									<button type="submit" class="pest_btn">Add to cart</button>
								</form>
					...
					<div class="col-lg-3 col-md-4 col-6">
						<div class="cake_feature_item">
							...
							<div class="cake_text">
								...
								<h3>Strawberry Cupcakes</h3>
								<form action="add_to_cart.php" method="post">
									<input type="hidden" name="image" value="img/cake-feature/c-feature-5.jpg">
									<input type="hidden" name="price" value="$29">
									<input type="hidden" name="name" value="Strawberry Cupcakes">
									<button type="submit" class="pest_btn">Add to cart</button>
								</form>
					...
					<div class="col-lg-3 col-md-4 col-6">
						<div class="cake_feature_item">
							...
							<div class="cake_text">
								...
								<h3>Strawberry Cupcakes</h3>
								<form action="add_to_cart.php" method="post">
									<input type="hidden" name="image" value="img/cake-feature/c-feature-6.jpg">
									<input type="hidden" name="price" value="$29">
									<input type="hidden" name="name" value="Strawberry Cupcakes">
									<button type="submit" class="pest_btn">Add to cart</button>
								</form>
					...
					<div class="col-lg-3 col-md-4 col-6">
						<div class="cake_feature_item">
							...
							<div class="cake_text">
								...
								<h3>Strawberry Cupcakes</h3>
								<form action="add_to_cart.php" method="post">
									<input type="hidden" name="image" value="img/cake-feature/c-feature-7.jpg">
									<input type="hidden" name="price" value="$29">
									<input type="hidden" name="name" value="Strawberry Cupcakes">
									<button type="submit" class="pest_btn">Add to cart</button>
								</form>
					...
					<div class="col-lg-3 col-md-4 col-6">
						<div class="cake_feature_item">
							...
							<div class="cake_text">
								...
								<h3>Strawberry Cupcakes</h3>
								<form action="add_to_cart.php" method="post">
									<input type="hidden" name="image" value="img/cake-feature/c-feature-8.jpg">
									<input type="hidden" name="price" value="$29">
									<input type="hidden" name="name" value="Strawberry Cupcakes">
									<button type="submit" class="pest_btn">Add to cart</button>
								</form>
